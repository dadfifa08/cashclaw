...
function persistRawNote(payload: { conversationId: string; messageId: string; createdAt: number; role: "user" | "assistant" | "system"; title: string; text: string; status: string; caseId?: string; artifactIds?: string[]; input?: CateoAssistInput; error?: string; highlights?: string[]; nextActions?: string[] }) {
